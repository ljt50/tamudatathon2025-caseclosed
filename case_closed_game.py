...
class Agent:
    ...
    def __init__(self, agent_id: str, start_pos: tuple[int, int], start_dir: Direction, board: GameBoard):
        ...
        self.board.set_cell_state(start_pos, AGENT1 if agent_id == 1 else AGENT2)
        self.board.set_cell_state(second, AGENT1 if agent_id == 1 else AGENT2)
    ...
    def move(self, direction: Direction, other_agent: Optional['Agent'] = None, use_boost: bool = False) -> bool:
        ...
        for move_num in range(num_moves):
            ...
            if cell_state == AGENT1 or cell_state == AGENT2:
            ...
            self.length += 1
            self.board.set_cell_state(new_head, AGENT1 if self.agent_id == 1 else AGENT2)
